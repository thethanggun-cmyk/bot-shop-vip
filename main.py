...
app = Flask('')
@app.route('/')
def home(): return "CLONE_STORE_FULL_VERSION_V2"
...
TEN_NGAN_HANG = "MB BANK" # Sửa tên ngân hàng của mày
STK = "0356133246" # Sửa số tài khoản của mày
...
class NapTienModal(Modal, title='THÔNG TIN CHUYỂN KHOẢN'):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        async def confirm_callback(inter):
            ...
            # Đã sửa lại thông báo theo ý mày
